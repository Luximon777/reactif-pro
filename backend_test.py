...
class ReActifProAPITester:
    def __init__(self):
        self.base_url = "https://partenaires-workflow.preview.emergentagent.com/api"
        self.token = None
...
def main():
    ...
    print(f"Testing backend at: https://partenaires-workflow.preview.emergentagent.com/api")
