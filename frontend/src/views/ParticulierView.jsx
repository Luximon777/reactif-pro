...
const ParticulierView = ({ token, section }) => {
  ...
  const metrics = [
    ...
    { title: "Métiers Compatibles", value: jobs.filter(j => j.match_score >= 60).length.toString(), icon: Briefcase, color: "emerald", subtitle: "Passerelles identifiées" },
    ...
    <div className="space-y-8 animate-fade-in" data-testid="particulier-dashboard">
      ...
      <Card className="card-base" data-testid="jobs-preview">
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            <CardTitle className="flex items-center gap-2"><Briefcase className="w-5 h-5 text-[#1e3a5f]" />Passerelles Métiers</CardTitle>
...
const JobsSection = ({ jobs, token }) => (
  <div className="space-y-6 animate-fade-in" data-testid="jobs-section">
    <div>
      <h1 className="text-2xl font-bold text-slate-900" style={{ fontFamily: 'Outfit, sans-serif' }}>Passerelles Métiers</h1>
