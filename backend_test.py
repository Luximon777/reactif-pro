...
class ReActifProAPITester:
    def __init__(self):
        self.base_url = "https://reactif-pro-preview.preview.emergentagent.com/api"
        self.token = None
...
def main():
    ...
    print(f"Testing backend at: https://reactif-pro-preview.preview.emergentagent.com/api")
