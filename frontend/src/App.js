  ...
  return (
    <div className="landing-page declic-theme">
      ...
      <div className="path-selection">
        ...
        {/* Section Au-delà du diplôme - Entre les deux accès */}
        <div className="beyond-diploma-section beyond-diploma-between">
          <div className="beyond-diploma-container">
            <div className="beyond-diploma-header">
              <GraduationCap size={28} className="beyond-diploma-icon" />
