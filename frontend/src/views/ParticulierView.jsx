...
const ParticulierView = ({ token, section, onOpenDclic }) => {
  ...
  return (
    <div className="space-y-8 animate-fade-in" data-testid="particulier-dashboard">
      ...
      <Card className="sm:col-span-2 lg:col-span-4 bg-gradient-to-r from-indigo-600 to-blue-600 border-0 shadow-md cursor-pointer hover:shadow-lg transition-shadow" data-testid="dclic-test-banner" onClick={() => window.location.href = '/test-dclic'}>
        <CardContent className="p-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            ...
            <Button className="bg-white text-indigo-700 hover:bg-indigo-50 shrink-0 text-sm font-semibold" data-testid="dclic-test-btn" onClick={e => { e.stopPropagation(); window.location.href = '/test-dclic'; }}>
