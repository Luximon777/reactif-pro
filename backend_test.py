...
class ReActifProAPITester:
    def __init__(self):
        self.base_url = "https://talent-insights-hub-1.preview.emergentagent.com/api"
        self.token = None
...
def main():
    ...
    print(f"Testing backend at: https://talent-insights-hub-1.preview.emergentagent.com/api")
