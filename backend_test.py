...
class ReActifProAPITester:
    def __init__(self):
        self.base_url = "https://resume-builder-pro-19.preview.emergentagent.com/api"
        self.token = None
...
def main():
    ...
    print(f"Testing backend at: https://resume-builder-pro-19.preview.emergentagent.com/api")
