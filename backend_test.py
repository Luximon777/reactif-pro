...
class ReActifProAPITester:
    def __init__(self):
        self.base_url = "https://observatoire-skills.preview.emergentagent.com/api"
        self.token = None
...
def main():
    ...
    print(f"Testing backend at: https://observatoire-skills.preview.emergentagent.com/api")
